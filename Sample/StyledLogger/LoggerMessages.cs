...
public static partial class LoggerMessages
{
    ...
    public static partial void ApplicationInfo(this ILogger logger, string message);
    ...
    [LoggerMessage(
        ...
        Message = "Application warning in member {member} on line number {lineNumber}. Message is: {message}")]
    public static partial void ApplicationWarning(
        ILogger logger,
        string message,
